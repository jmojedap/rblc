...
<div id="product_images">
    ...
    <div id="image_gallery">
        <div class="card w100pc" v-for="(image, image_key) in images">
            ...
            <div class="p-1">
                <button class="btn btn-sm" v-on:click="set_main_image(image_key)" v-bind:class="{'btn-primary': image.main == 1, 'btn-light': image.main == 0 }" title="Establecer como principal">
