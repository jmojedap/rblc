...
var project_images = new Vue({
    ...
    methods: {
        get_list: function(){
            axios.get(url_api + 'posts/get_images/' + this.project_id)
            .then(response => {
        ...
        send_file_form: function(){
            ...
            form_data.append('related_1', this.project_id)
        ...
        delete_element: function(){
            ...
            .then(response => {
                if (response.data.qty_deleted > 0) {
                    ...
                    toastr['warning']('The image was not deleted')
                }
            })
            .catch(function (error) { console.log(error) })
        },
        set_main_image: function(key){
            ...
            axios.get(url_api + 'posts/set_main_image/' + this.project_id + '/' + file_id)
            .then(response => {
                if ( response.data.status == 1 ) this.get_list()
            })
            .catch(function (error) { console.log(error) })
