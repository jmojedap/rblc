...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v8.0&appId=<?= $app_id ?>&autoLogAppEvents=1" nonce="F9edceQl"></script>

<script>
    var signup_role_type = 'homeowner';
...
//-----------------------------------------------------------------------------
    ...
    function validateLogin(access_token)
    {
      FB.api('/me', {fields: 'email, last_name, first_name'}, function(fbUserData) {
        ...
        console.log('signup_role_type:', signup_role_type);
