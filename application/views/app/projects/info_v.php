...
<div id="project_info">
    <div class="row">
        <div class="col-md-8">
            <img class="w100pc" v-bind:src="current_image.url" alt="Main image of project" onerror="this.src='<?= URL_IMG ?>front/sm_coming_soon.png'">
            <br>
                    ...
                    <div class="p-2">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                ...
                                <a href="<?= URL_FRONT . 'ideabooks/add' ?>" class="dropdown-item">
        ...
        <div class="col-md-4">
            ...
            <div>
                ...
                <?php if ( $editable ) { ?>
                    <a href="<?= URL_FRONT . "projects/edit/{$row->id}" ?>" class="btn btn-white btn-block mb-2"> EDIT </a>
                <?php } ?>
            </div>
