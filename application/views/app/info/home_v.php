    ...
    <div class="home">
        ...
        <div class="three-buttons bg-blue only-lg">
            <div class="icons text-center">
                <div class="d-flex">
                    <a class="icon" href="<?= URL_FRONT . 'pictures/explore' ?>">
                    ...
                    <a class="icon" href="<?= URL_FRONT . 'professionals/explore' ?>">
                    ...
                    <a class="icon" href="<?= URL_FRONT . 'projects/explore' ?>">
        ...
        <div style="background-image: url('<?= URL_IMG ?>home/home-footer-1.jpg')" class="img-footer only-lg">
            ...
            <a href="<?= URL_FRONT . "accounts/signup" ?>" class="btn btn-xl btn-main w210p">
                REGISTER NOW
            </a>
        </div>
    </div>
