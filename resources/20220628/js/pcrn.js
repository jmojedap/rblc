 ...
 */
 ...
 var Pcrn = new function()
 {
     ...
     /**
      * Convierte un string de fecha en formato MySQL (ISO) a objeto Date de Javascript
      * @param {string} sql_date 
      * @returns Javascript Date Object
      */
     this.jsDate = function (sql_date){
         var jsDate = new Date(Date.parse(sql_date.replace(/[-]/g,'/')))
         return jsDate
     }
 };